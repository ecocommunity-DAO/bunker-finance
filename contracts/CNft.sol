...
contract CNft is CNftInterface, ERC1155, IERC1155Receiver, IERC721Receiver, ReentrancyGuard {
    constructor (
        string memory _uri,
        address _underlying,
        bool _isPunk,
    ...
    function mint(
        ...
        if (is1155) {
            ...
            if (isPunk) {
                ...
                // TODO: NFTX does some checks (see https://github.com/NFTX-project/nftx-protocol-v2/blob/master/contracts/solidity/NFTXVaultUpgradeable.sol#L414-L419)
                // so maybe we need to do the same.
                for (uint256 i; i < length; ++i) {
    ...
    // TODO: Extract checking for ownership, checking for redeeming, and transferring into a library.
